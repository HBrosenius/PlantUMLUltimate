...
function ParticipantKindPreview({ kind }: { kind: SequenceParticipantKind }) {
  return (
    <svg className="participant-kind-preview" viewBox="0 0 94 30" aria-hidden="true">
      ...
      {kind === "boundary" && (
        <>
          <circle cx="49" cy="15" r="10" />
          <path d="M36 4V26M36 15H39" />
        </>
      )}
      {kind === "control" && (
        <>
          <circle cx="47" cy="16" r="10" />
          <path d="M47 6C51 2 56 3 58 6M58 6L54 5M58 6L56 2" />
        </>
      )}
      {kind === "entity" && (
        <>
          <circle cx="47" cy="13" r="10" />
          <path d="M35 27H59" />
        </>
      )}
      {kind === "database" && (
        <>
          <path d="M28 8C28 2 66 2 66 8V22C66 28 28 28 28 22Z" />
          <path d="M28 8C28 14 66 14 66 8M28 15C28 21 66 21 66 15" />
        </>
      )}
      {kind === "collections" && (
        <>
          <rect x="30" y="7" width="38" height="19" rx="2" />
          <rect x="25" y="3" width="38" height="19" rx="2" />
        </>
      )}
      {kind === "queue" && (
        <>
          <circle cx="47" cy="15" r="11" />
          <path d="M38 11H56M38 15H56M38 19H56" />
        </>
      )}
    </svg>
  );
