// Generated from the OpenIconic sprite set bundled in @plantuml/core (openiconic.js), the
// same catalog PlantUML uses to render a WBS node's "<&name>" icon reference. Regenerate by
// re-running the extraction script in the PR that bumps @plantuml/core if the set ever changes.
export const WBS_OPENICONIC_ICONS: ReadonlyArray<readonly [name: string, svgMarkup: string]> = [
  ["account-login", '<path d="M3 0v1h4v5h-4v1h5v-7h-5zm1 2v1h-4v1h4v1l2-1.5-2-1.5z" />'],
  ["account-logout", '<path d="M3 0v1h4v5h-4v1h5v-7h-5zm-1 2l-2 1.5 2 1.5v-1h4v-1h-4v-1z" />'],
  [
    "action-redo",
  ...
  ["align-center", '<path d="M0 0v1h8v-1h-8zm1 2v1h6v-1h-6zm-1 2v1h8v-1h-8zm1 2v1h6v-1h-6z" />'],
  ["align-left", '<path d="M0 0v1h8v-1h-8zm0 2v1h6v-1h-6zm0 2v1h8v-1h-8zm0 2v1h6v-1h-6z" />'],
  ["align-right", '<path d="M0 0v1h8v-1h-8zm2 2v1h6v-1h-6zm-2 2v1h8v-1h-8zm2 2v1h6v-1h-6z" />'],
  [
    "aperture",
  ...
  ["arrow-bottom", '<path d="M2 0v5h-2l2.53 3 2.47-3h-2v-5h-1z" transform="translate(1)" />'],
  [
    "arrow-circle-bottom",
  ...
  ["arrow-left", '<path d="M3 0l-3 2.53 3 2.47v-2h5v-1h-5v-2z" transform="translate(0 1)" />'],
  ["arrow-right", '<path d="M5 0v2h-5v1h5v2l3-2.53-3-2.47z" transform="translate(0 1)" />'],
  ["arrow-thick-bottom", '<path d="M2 0v5h-2l3.03 3 2.97-3h-2v-5h-2z" transform="translate(1)" />'],
  ["arrow-thick-left", '<path d="M3 0l-3 3.03 3 2.97v-2h5v-2h-5v-2z" transform="translate(0 1)" />'],
  ["arrow-thick-right", '<path d="M5 0v2h-5v2h5v2l3-3.03-3-2.97z" transform="translate(0 1)" />'],
  ["arrow-thick-top", '<path d="M2.97 0l-2.97 3h2v5h2v-5h2l-3.03-3z" transform="translate(1)" />'],
  ["arrow-top", '<path d="M2.47 0l-2.47 3h2v5h1v-5h2l-2.53-3z" transform="translate(1)" />'],
  ["audio-spectrum", '<path d="M4 0v8h1v-8h-1zm-2 1v6h1v-6h-1zm4 1v4h1v-4h-1zm-6 1v2h1v-2h-1z" />'],
  [
    "audio",
  ...
  ["bar-chart", '<path d="M0 0v7h8v-1h-7v-6h-1zm5 0v5h2v-5h-2zm-3 2v3h2v-3h-2z" />'],
  [
    "basket",
  ...
  ["bolt", '<path d="M3 0l-3 5h2v3l3-5h-2v-3z" transform="translate(1)" />'],
  [
    "book",
  ...
  ["bookmark", '<path d="M0 0v8l2-2 2 2v-8h-4z" transform="translate(2)" />'],
  [
    "box",
  ...
  ["caret-bottom", '<path d="M0 0l4 4 4-4h-8z" transform="translate(0 2)" />'],
  ["caret-left", '<path d="M4 0l-4 4 4 4v-8z" transform="translate(2)" />'],
  ["caret-right", '<path d="M0 0v8l4-4-4-4z" transform="translate(2)" />'],
  ["caret-top", '<path d="M4 0l-4 4h8l-4-4z" transform="translate(0 2)" />'],
  [
    "cart",
  ...
  ["chat", '<path d="M0 0v5l1-1h1v-3h3v-1h-5zm3 2v4h4l1 1v-5h-5z" />'],
  [
    "check",
  ...
  ["chevron-bottom", '<path d="M1.5 0l-1.5 1.5 4 4 4-4-1.5-1.5-2.5 2.5-2.5-2.5z" transform="translate(0 1)" />'],
  ["chevron-left", '<path d="M4 0l-4 4 4 4 1.5-1.5-2.5-2.5 2.5-2.5-1.5-1.5z" transform="translate(1)" />'],
  ["chevron-right", '<path d="M1.5 0l-1.5 1.5 2.5 2.5-2.5 2.5 1.5 1.5 4-4-4-4z" transform="translate(1)" />'],
  ["chevron-top", '<path d="M4 0l-4 4 1.5 1.5 2.5-2.5 2.5 2.5 1.5-1.5-4-4z" transform="translate(0 1)" />'],
  [
    "circle-check",
  ...
  ["collapse-down", '<path d="M0 0v2h8v-2h-8zm2 3l2 2 2-2h-4zm-2 4v1h8v-1h-8z" />'],
  ["collapse-left", '<path d="M0 0v8h1v-8h-1zm6 0v8h2v-8h-2zm-1 2l-2 2 2 2v-4z" />'],
  ["collapse-right", '<path d="M0 0v8h2v-8h-2zm7 0v8h1v-8h-1zm-4 2v4l2-2-2-2z" />'],
  ["collapse-up", '<path d="M0 0v1h8v-1h-8zm4 3l-2 2h4l-2-2zm-4 3v2h8v-2h-8z" />'],
  [
    "command",
  ...
  ["data-transfer-upload", '<path d="M0 0v1h8v-1h-8zm4 2l-3 3h2v3h2v-3h2l-3-3z" />'],
  [
    "delete",
  ...
  ["double-quote-sans-left", '<path d="M0 0v6l3-3v-3h-3zm5 0v6l3-3v-3h-3z" transform="translate(0 1)" />'],
  ["double-quote-sans-right", '<path d="M3 0l-3 3v3h3v-6zm5 0l-3 3v3h3v-6z" transform="translate(0 1)" />'],
  [
  ...
  ["eject", '<path d="M4 0l-4 5h8l-4-5zm-4 6v2h8v-2h-8z" />'],
  ["elevator", '<path d="M3 0l-3 3h6l-3-3zm-3 5l3 3 3-3h-6z" transform="translate(1)" />'],
  ["ellipses", '<path d="M0 0v2h2v-2h-2zm3 0v2h2v-2h-2zm3 0v2h2v-2h-2z" transform="translate(0 3)" />'],
  ["envelope-closed", '<path d="M0 0v1l4 2 4-2v-1h-8zm0 2v4h8v-4l-4 2-4-2z" transform="translate(0 1)" />'],
  [
    "envelope-open",
  ...
  ["expand-down", '<path d="M0 0v1h8v-1h-8zm2 2l2 2 2-2h-4zm-2 4v2h8v-2h-8z" />'],
  ["expand-left", '<path d="M0 0v8h1v-8h-1zm6 0v8h2v-8h-2zm-4 2v4l2-2-2-2z" />'],
  ["expand-right", '<path d="M0 0v8h2v-8h-2zm7 0v8h1v-8h-1zm-1 2l-2 2 2 2v-4z" />'],
  ["expand-up", '<path d="M0 0v2h8v-2h-8zm4 4l-2 2h4l-2-2zm-4 3v1h8v-1h-8z" />'],
  ["external-link", '<path d="M0 0v8h8v-2h-1v1h-6v-6h1v-1h-2zm4 0l1.5 1.5-2.5 2.5 1 1 2.5-2.5 1.5 1.5v-4h-4z" />'],
  [
    "eye",
  ...
  ["file", '<path d="M0 0v8h7v-4h-4v-4h-3zm4 0v3h3l-3-3z" />'],
  [
    "fire",
  ...
  ["folder", '<path d="M0 0v2h8v-1h-5v-1h-3zm0 3v4.5c0 .28.22.5.5.5h7c.28 0 .5-.22.5-.5v-4.5h-8z" />'],
  [
    "fork",
  ...
  ["graph", '<path d="M7.03 0l-3.03 3-1-1-3 3.03 1 1 2-2.03 1 1 4-4-.97-1zm-7.03 7v1h8v-1h-8z" />'],
  [
    "grid-four-up",
  ...
  ["grid-two-up", '<path d="M0 0v3h3v-3h-3zm5 0v3h3v-3h-3zm-5 5v3h3v-3h-3zm5 0v3h3v-3h-3z" />'],
  [
    "hard-drive",
  ...
  ["image", '<path d="M0 0v8h8v-8h-8zm1 1h6v3l-1-1-1 1 2 2v1h-1l-4-4-1 1v-3z" />'],
  [
    "inbox",
  ...
  ["italic", '<path d="M2 0v1h1.63l-.06.13-2 5-.34.88h-1.22v1h5v-1h-1.63l.06-.13 2-5 .34-.88h1.22v-1h-5z" />'],
  ["justify-center", '<path d="M0 0v1h8v-1h-8zm0 2v1h8v-1h-8zm0 2v1h8v-1h-8zm1 2v1h6v-1h-6z" />'],
  ["justify-left", '<path d="M0 0v1h8v-1h-8zm0 2v1h8v-1h-8zm0 2v1h8v-1h-8zm0 2v1h6v-1h-6z" />'],
  ["justify-right", '<path d="M0 0v1h8v-1h-8zm0 2v1h8v-1h-8zm0 2v1h8v-1h-8zm2 2v1h6v-1h-6z" />'],
  [
    "key",
  ...
  ["location", '<path d="M8 0l-8 4 3 1 1 3 4-8z" />'],
  [
    "lock-locked",
  ...
  ["media-record", '<path d="M3 0c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" transform="translate(1 1)" />'],
  ["media-skip-backward", '<path d="M4 0l-4 3 4 3v-6zm0 3l4 3v-6l-4 3z" transform="translate(0 1)" />'],
  ["media-skip-forward", '<path d="M0 0v6l4-3-4-3zm4 3v3l4-3-4-3v3z" transform="translate(0 1)" />'],
  ["media-step-backward", '<path d="M0 0v6h2v-6h-2zm2 3l5 3v-6l-5 3z" transform="translate(0 1)" />'],
  ["media-step-forward", '<path d="M0 0v6l5-3-5-3zm5 3v3h2v-6h-2v3z" transform="translate(0 1)" />'],
  ["media-stop", '<path d="M0 0v6h6v-6h-6z" transform="translate(1 1)" />'],
  ["medical-cross", '<path d="M2 0v2h-2v4h2v2h4v-2h2v-4h-2v-2h-4z" />'],
  ["menu", '<path d="M0 0v1h8v-1h-8zm0 2.97v1h8v-1h-8zm0 3v1h8v-1h-8z" transform="translate(0 1)" />'],
  [
    "microphone",
  ...
  ["minus", '<path d="M0 0v2h8v-2h-8z" transform="translate(0 3)" />'],
  [
    "monitor",
  ...
  ["play-circle", '<path d="M4 0c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm-1 2l3 2-3 2v-4z" />'],
  ...
  ["project", '<path d="M0 0v7h1v-7h-1zm7 0v7h1v-7h-1zm-5 1v1h2v-1h-2zm1 2v1h2v-1h-2zm1 2v1h2v-1h-2z" />'],
  [
    "pulse",
  ...
  ["resize-both", '<path d="M4 0l1.66 1.66-4 4-1.66-1.66v4h4l-1.66-1.66 4-4 1.66 1.66v-4h-4z" />'],
  ...
  ["share", '<path d="M5 0v2c-4 0-5 2.05-5 5 .52-1.98 2-3 4-3h1v2l3-3.16-3-2.84z" />'],
  [
    "shield",
  ...
  ["signal", '<path d="M6 0v8h1v-8h-1zm-2 1v7h1v-7h-1zm-2 2v5h1v-5h-1zm-2 2v3h1v-3h-1z" />'],
  ["signpost", '<path d="M3 0v1h-2l-1 1 1 1h2v5h1v-4h2l1-1-1-1h-2v-2h-1z" />'],
  ["sort-ascending", '<path d="M2 0v6h-2l2.5 2 2.5-2h-2v-6h-1zm2 0v1h2v-1h-2zm0 2v1h3v-1h-3zm0 2v1h4v-1h-4z" />'],
  ["sort-descending", '<path d="M2 0v6h-2l2.5 2 2.5-2h-2v-6h-1zm2 0v1h4v-1h-4zm0 2v1h3v-1h-3zm0 2v1h2v-1h-2z" />'],
  [
    "spreadsheet",
  ...
  ["star", '<path d="M4 0l-1 3h-3l2.5 2-1 3 2.5-2 2.5 2-1-3 2.5-2h-3l-1-3z" />'],
  [
    "sun",
  ...
  ["task", '<path d="M0 0v7h7v-3.59l-1 1v1.59h-5v-5h3.59l1-1h-5.59zm7 0l-3 3-1-1-1 1 2 2 4-4-1-1z" />'],
  [
    "terminal",
  ...
  ["transfer", '<path d="M6 0v1h-6v1h6v1l2-1.5-2-1.5zm-4 4l-2 1.5 2 1.5v-1h6v-1h-6v-1z" />'],
  [
    "trash",
  ...
  ["volume-off", '<path d="M3.34 0l-1.34 2h-2v4h2l1.34 2h.66v-8h-.66z" transform="translate(2)" />'],
  [
    "warning",
